class USMC_WD {
    class Base {
		...
		uniforms[] = {"rhs_uniform_FROG01_wd"};

		vests[] = {"rhsusf_spc_rifleman"};
		
		backpacks[] = {"rhsusf_assault_eagleaiii_coy"};
    ...
    class FTL: SL {
		...
		vests[] = {"rhsusf_spc_teamleader"};

		radios[] = {RIFLEMAN_RADIO};
    };

    class Medic: Base {
		vests[] = {"rhsusf_spc_corpsman"};
